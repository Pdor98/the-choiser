...
function ViewModeToggle({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid gap-2 rounded-[24px] border border-white/8 bg-white/5 p-2 sm:grid-cols-2">
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={`inline-flex min-h-12 items-center justify-center gap-2 rounded-full border px-4 py-2.5 text-sm font-semibold transition duration-300 ${
                isActive
                  ? "border-cyan-300/24 bg-[linear-gradient(135deg,rgba(34,211,238,0.18),rgba(59,130,246,0.28)_55%,rgba(99,102,241,0.22))] text-slate-50 shadow-[0_18px_40px_-28px_rgba(56,189,248,0.32)]"
                  : "border-white/8 bg-white/4 text-slate-300 hover:border-cyan-300/18 hover:bg-white/8 hover:text-slate-50"
              }`}
            >
  ...
  return (
    <div className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(11,21,37,0.96),rgba(15,29,50,0.94))] p-5 shadow-[0_24px_60px_-38px_rgba(37,99,235,0.26)] sm:p-6">
      <div className="mx-auto flex max-w-[280px] flex-col items-center gap-6">
        ...
        >
          <div className="absolute inset-x-1/2 top-0 h-4 w-28 -translate-x-1/2 rounded-full border border-white/10 bg-slate-900 shadow-[0_12px_24px_-18px_rgba(15,23,42,0.65)]" />
          <div className="absolute inset-x-1/2 bottom-0 h-4 w-28 -translate-x-1/2 rounded-full border border-white/10 bg-slate-900 shadow-[0_-12px_24px_-18px_rgba(15,23,42,0.45)]" />
          ...
          <div className="absolute left-1/2 top-5 h-[112px] w-[150px] -translate-x-1/2 overflow-hidden [clip-path:polygon(8%_0%,92%_0%,62%_100%,38%_100%)]">
            <div className="absolute inset-0 border border-white/10 bg-[linear-gradient(180deg,rgba(14,27,47,0.98),rgba(20,37,62,0.9))]" />
            <motion.div
          ...
          <div className="absolute left-1/2 top-[122px] h-[56px] w-1.5 -translate-x-1/2 overflow-hidden rounded-full bg-white/6">
            <motion.div
      ...
      <div className="relative grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)] lg:items-start lg:gap-8">
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full border border-white/8 bg-white/5 px-3 py-1 text-xs uppercase tracking-[0.18em] text-slate-400">
              Utility deck
            </span>
          </div>
          ...
          <div className="rounded-[24px] border border-white/8 bg-white/5 p-4">
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex size-10 items-center justify-center rounded-2xl bg-cyan-300/12 text-cyan-200">
