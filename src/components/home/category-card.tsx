...
export function CategoryCard({
  ...
  return (
    <Link href={href} className="group h-full">
      <Card className="relative flex h-full flex-col justify-between overflow-hidden border-white/8 bg-[linear-gradient(180deg,rgba(10,20,35,0.94),rgba(14,28,48,0.9))] p-6 transition duration-500 hover:-translate-y-1.5 hover:border-cyan-300/18 hover:bg-[linear-gradient(180deg,rgba(12,24,42,0.96),rgba(16,31,54,0.92))]">
        <div
        ...
        <div className="relative space-y-8">
          ...
          <div className="space-y-3">
            ...
            <h2 className="font-heading text-2xl font-semibold tracking-tight text-slate-50 sm:text-[1.75rem]">
              {title}
            </h2>
        ...
        <div className="relative mt-8 flex items-center justify-between rounded-[22px] border border-white/8 bg-white/5 px-4 py-3 text-sm text-slate-300">
