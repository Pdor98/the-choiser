...
export function HeaderQuickSwitch() {
  ...
  return (
    <div className="space-y-2.5 sm:space-y-4">
      ...
      <div className="mx-auto flex max-w-full snap-x snap-mandatory items-center justify-start gap-1.5 overflow-x-auto rounded-[22px] border border-white/8 bg-[linear-gradient(180deg,rgba(9,18,33,0.88),rgba(13,25,44,0.88))] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden md:max-w-4xl md:flex-wrap md:justify-center md:gap-2 md:rounded-[26px] md:p-2.5">
        {navigationLinks.map((link) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "inline-flex min-h-11 shrink-0 snap-center items-center gap-2 rounded-full border px-3 py-2 text-[12px] font-semibold transition duration-300 md:min-h-12 md:px-4 md:py-2.5 md:text-sm",
                isActive
