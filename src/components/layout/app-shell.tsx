  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.18),transparent_26%),radial-gradient(circle_at_84%_14%,rgba(99,102,241,0.18),transparent_22%),radial-gradient(circle_at_50%_120%,rgba(14,165,233,0.16),transparent_26%),linear-gradient(180deg,#07111d_0%,#0a1524_42%,#0d1b2e_100%)]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[90rem] flex-col gap-6 px-3.5 py-3.5 sm:gap-8 sm:px-6 sm:py-6 lg:px-8 xl:px-10">
        ...
        <main
          id="top"
          className="flex-1 pb-10 pt-2 sm:pb-12 sm:pt-3"
        >
          {children}
        </main>
      </div>
