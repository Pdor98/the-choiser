        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-3xl text-sm leading-7 text-slate-300/88 sm:text-base sm:leading-7">
              La pagina Random ora parte da un suggerimento concreto su cosa
              fare oggi e affianca un piccolo libro delle risposte, elegante e
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm leading-7 text-slate-300">
                Today Prompt a sinistra, Libro delle risposte sulla destra e
                numero casuale spostato piu in basso come modulo extra.
              </p>
